...
public class PagoDTO {
	...
	private int id_Cliente;// Pido esto
	private LocalDateTime  fecha_Pago;
	private double Monto;// Pido esto
	private Estado Estado;// este es el enum
	private int Id_Reserva ; // Pido esto
	...
	public PagoDTO(String id_pago, int id_Cliente, LocalDateTime fecha_Pago, double monto,
